...
public class MemoTest {
    ...
    public void testMemoHashSuccess() {
        MemoHash memo = Memo.Companion.hash("4142434445464748494a4b4c");
        assertEquals(MemoType.MEMO_HASH, memo.toXdr().getDiscriminant());
        String test = "ABCDEFGHIJKL";
        Assert.assertEquals(test, Util.paddedByteArrayToString(memo.getBytes()));
        assertEquals("4142434445464748494a4b4c", memo.getTrimmedHexValue());
    }

    @Test
    public void testMemoHashSuccessUppercase() {
        MemoHash memo = Memo.Companion.hash("4142434445464748494a4b4c".toUpperCase());
        assertEquals(MemoType.MEMO_HASH, memo.toXdr().getDiscriminant());
        String test = "ABCDEFGHIJKL";
    ...
    public void testMemoHashBytesSuccess() {
        ...
        MemoHash memo = Memo.Companion.hash(bytes);
        assertEquals(MemoType.MEMO_HASH, memo.toXdr().getDiscriminant());
    ...
    public void testMemoReturnHashSuccess() {
        MemoReturnHash memo = Memo.Companion.returnHash("4142434445464748494a4b4c");
