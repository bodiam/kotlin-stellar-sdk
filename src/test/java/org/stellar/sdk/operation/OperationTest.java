...
public class OperationTest {
  ...
  public void testCreateAccountOperation() throws FormatException, IOException, AssetCodeLengthInvalidException {
    ...
    CreateAccountOperation parsedOperation = (CreateAccountOperation) Operation.Companion.fromXdr(xdr);
  ...
  public void testPaymentOperation() throws FormatException, IOException, AssetCodeLengthInvalidException {
    ...
    Asset asset = NativeAsset.INSTANCE;
    String amount = "1000";
    ...
    org.stellar.sdk.xdr.Operation xdr = operation.toXdr();
    PaymentOperation parsedOperation = (PaymentOperation) Operation.Companion.fromXdr(xdr);

    assertEquals(10000000000L, xdr.getBody().getPaymentOp().getAmount().getInt64().longValue());
    assertEquals(source.getAccountId(), parsedOperation.getSourceAccount().getAccountId());
    assertEquals(destination.getAccountId(), parsedOperation.getDestination().getAccountId());
    assertTrue(parsedOperation.getAsset() instanceof NativeAsset);
  ...
  public void testPathPaymentOperation() throws FormatException, IOException, AssetCodeLengthInvalidException {
    ...
    Asset sendAsset = NativeAsset.INSTANCE;
    String sendMax = "0.0001";
    Asset destAsset = new IssuedAsset4("USD", issuer);
    String destAmount = "0.0001";
    Asset[] path = {new IssuedAsset4("USD", pathIssuer1), new IssuedAsset12("TESTTEST", pathIssuer2)};
    ...
    org.stellar.sdk.xdr.Operation xdr = operation.toXdr();
    PathPaymentOperation parsedOperation = (PathPaymentOperation) Operation.Companion.fromXdr(xdr);
    ...
    assertTrue(parsedOperation.getSendAsset() instanceof NativeAsset);
    assertEquals(source.getAccountId(), parsedOperation.getSourceAccount().getAccountId());
    assertEquals(destination.getAccountId(), parsedOperation.getDestination().getAccountId());
    assertEquals(sendMax, parsedOperation.getSendMax());
    assertTrue(parsedOperation.getDestAsset() instanceof IssuedAsset4);
  ...
  public void testChangeTrustOperation() throws FormatException, IOException {
    ...
    org.stellar.sdk.xdr.Operation xdr = operation.toXdr();
    ChangeTrustOperation parsedOperation = (ChangeTrustOperation) Operation.Companion.fromXdr(xdr);
  ...
  public void testAllowTrustOperation() throws IOException, FormatException {
    ...
    org.stellar.sdk.xdr.Operation xdr = operation.toXdr();
    AllowTrustOperation parsedOperation = (AllowTrustOperation) Operation.Companion.fromXdr(xdr);
  ...
  public void testSetOptionsOperation() throws FormatException {
    ...
    // GBCP5W2VS7AEWV2HFRN7YYC623LTSV7VSTGIHFXDEJU7S5BAGVCSETRR
    SignerKey signer = Signer.INSTANCE.ed25519PublicKey(KeyPair.fromSecretSeed("SA64U7C5C7BS5IHWEPA7YWFN3Z6FE5L6KAMYUIT4AQ7KVTVLD23C6HEZ"));
    ...
    org.stellar.sdk.xdr.Operation xdr = operation.toXdr();
    SetOptionsOperation parsedOperation = (SetOptionsOperation) SetOptionsOperation.Companion.fromXdr(xdr);
  ...
  public void testSetOptionsOperationSignerSha256() {
    ...
    SetOptionsOperation operation = new SetOptionsOperation.Builder()
            .setSigner(Signer.INSTANCE.sha256Hash(hash), 10)
            .setSourceAccount(source)
            .build();
  ...
  public void testSetOptionsOperationPreAuthTxSigner() {
    ...
    SetOptionsOperation operation = new SetOptionsOperation.Builder()
            .setSigner(Signer.INSTANCE.preAuthTx(transaction), 10)
  ...
  public void testManageOfferOperation() throws IOException, FormatException {
    ...
    Asset selling = NativeAsset.INSTANCE;
    ...
    org.stellar.sdk.xdr.Operation xdr = operation.toXdr();
    ManageOfferOperation parsedOperation = (ManageOfferOperation) ManageOfferOperation.Companion.fromXdr(xdr);

    assertEquals(100L, xdr.getBody().getManageOfferOp().getAmount().getInt64().longValue());
    assertTrue(parsedOperation.getSelling() instanceof NativeAsset);
    assertTrue(parsedOperation.getBuying() instanceof IssuedAsset4);
  ...
  public void testCreatePassiveOfferOperation() throws IOException, FormatException {
    ...
    org.stellar.sdk.xdr.Operation xdr = operation.toXdr();
    CreatePassiveOfferOperation parsedOperation = (CreatePassiveOfferOperation) CreatePassiveOfferOperation.Companion.fromXdr(xdr);
  ...
  public void testAccountMergeOperation() throws IOException, FormatException {
    ...
    AccountMergeOperation parsedOperation = (AccountMergeOperation) Operation.Companion.fromXdr(xdr);
  ...
  public void testManageDataOperation() throws IOException, FormatException {
    ...
    ManageDataOperation parsedOperation = (ManageDataOperation) Operation.Companion.fromXdr(xdr);
  ...
  public void testBumpSequence() throws IOException, FormatException {
    ...
    BumpSequenceOperation parsedOperation = (BumpSequenceOperation) Operation.Companion.fromXdr(xdr);
  ...
  public void testToXdrAmount() {
    assertEquals(0L, Operation.Companion.toXdrAmount("0"));
    assertEquals(1L, Operation.Companion.toXdrAmount("0.0000001"));
    assertEquals(10000000L, Operation.Companion.toXdrAmount("1"));
    assertEquals(11234567L, Operation.Companion.toXdrAmount("1.1234567"));
    assertEquals(729912843007381L, Operation.Companion.toXdrAmount("72991284.3007381"));
    assertEquals(729912843007381L, Operation.Companion.toXdrAmount("72991284.30073810"));
    assertEquals(1014016711446800155L, Operation.Companion.toXdrAmount("101401671144.6800155"));
    assertEquals(9223372036854775807L, Operation.Companion.toXdrAmount("922337203685.4775807"));

    try {
      Operation.Companion.toXdrAmount("0.00000001");
      fail();
    }
    ...
    try {
      Operation.Companion.toXdrAmount("72991284.30073811");
      fail();
    }
    catch (ArithmeticException e) {}
    catch (Exception e) { fail(); }
  ...
  public void testFromXdrAmount() {
    assertEquals("0", Operation.Companion.fromXdrAmount(0L));
    assertEquals("0.0000001", Operation.Companion.fromXdrAmount(1L));
    assertEquals("1", Operation.Companion.fromXdrAmount(10000000L));
    assertEquals("1.1234567", Operation.Companion.fromXdrAmount(11234567L));
    assertEquals("72991284.3007381", Operation.Companion.fromXdrAmount(729912843007381L));
    assertEquals("101401671144.6800155", Operation.Companion.fromXdrAmount(1014016711446800155L));
    assertEquals("922337203685.4775807", Operation.Companion.fromXdrAmount(9223372036854775807L));
  }
}
