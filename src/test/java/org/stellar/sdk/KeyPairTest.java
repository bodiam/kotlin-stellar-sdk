...
import static org.stellar.sdk.Util.*;
...
public class KeyPairTest {
  ...
  public void testSign() {
    ...
    KeyPair keypair = KeyPair.fromSecretSeed(hexToBytes(SEED));
    String data = "hello world";
    byte[] sig = keypair.sign(data.getBytes());
    Assert.assertArrayEquals(hexToBytes(expectedSig), sig);
  }
  ...
  public void testVerifyTrue() throws Exception {
    ...
    String data = "hello world";
    KeyPair keypair = KeyPair.fromSecretSeed(hexToBytes(SEED));
    Assert.assertTrue(keypair.verify(data.getBytes(), hexToBytes(sig)));
  }
  ...
  public void testVerifyFalse() throws Exception {
    ...
    String data = "hello world";
    KeyPair keypair = KeyPair.fromSecretSeed(hexToBytes(SEED));
    Assert.assertFalse(keypair.verify(data.getBytes(), hexToBytes(badSig)));
